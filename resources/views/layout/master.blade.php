...
<head>
  ...
  <title>Opet Vet Shop | Dashboard</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
	<link rel="shortcut icon" type="image/jpg" href="{{ asset('assets/image/opet-logo.jpeg') }}">
  <!-- Bootstrap 3.3.7 -->
    ...
    <input class="baseUrl" type="hidden" value="{{ url('/') }}"/>
		<header class="main-header">
			...
			<a href="{{ url('/') }}" class="logo">
				...
				<span class="logo-lg"><b>OPET</b> <b>VET</b> SHOP</span>
			</a>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; <script>document.write(new Date().getFullYear())</script> <a href="{{ url('/') }}">Opet Vet Shop</a></strong> | Powered by Scoop Tech
		</footer>
